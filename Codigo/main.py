...
screen_width = 400
screen_height = 400
#vc para el obser. (vista 2D ortografica)
ZNEAR=0.1
ZFAR=2000.0
#Variables para definir la posicion del observador (vista cenital 2D)
#gluLookAt(EYE_X,EYE_Y,EYE_Z,CENTER_X,CENTER_Y,CENTER_Z,UP_X,UP_Y,UP_Z)
EYE_X = 200.0   # Centro del tablero en X
EYE_Y = 600.0   # Alto sobre el tablero (mirando hacia abajo)
EYE_Z = 200.0   # Centro del tablero en Z
CENTER_X = 200.0
CENTER_Y = 0.0
CENTER_Z = 200.0
UP_X=0
UP_Y=0
UP_Z=-1  # Eje Z negativo como "arriba" de pantalla (necesario al mirar desde +Y)
...
def Init():
    ...
    glLoadIdentity()
    # Proyeccion ortografica para vista 2D cenital
    # El tablero va de 0 a DimBoard (400) en X y Z, centrado en (200,200)
    # En espacio de vista: X = worldX - 200, Y = 200 - worldZ
    glOrtho(-DimBoard/2, DimBoard/2, -DimBoard/2, DimBoard/2, ZNEAR, ZFAR)
